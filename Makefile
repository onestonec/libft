...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2022/05/23 19:17:09 by wcheung           #+#    #+#              #
#    Updated: 2022/05/23 19:17:30 by wcheung          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS=ft_atoi.c ft_bzero.c ft_isalnum.c \
	 ...
	 ft_strrchr.c ft_strsplit.c ft_strsplitchrset.c ft_strstr.c \
...
OBJECTS=ft_atoi.o ft_bzero.o ft_isalnum.o \
		...
		ft_strrchr.o ft_strsplit.o ft_strsplitchrset.o ft_strstr.o \
